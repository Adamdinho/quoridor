quoridojo: bin/duchess.o bin/quoridojo.o 
	gcc -O0 -g -Wall quoridojo.o common_structs.o choose_move_or_wall.o game_tree.o game_state.o duchess_init.o -o quoridojo

bin/quoridojo.o: src/quoridojo/quoridojo.c
	gcc -c -g -Wall src/quoridojo/quoridojo.c
